      ...
      <div className="min-h-screen bg-white font-sans">
         ...
         <div className="py-24 bg-white text-center">
            <div className="max-w-4xl mx-auto px-4">
               ...
               {/* RIDER PAIN POINTS */}
               <div className="bg-gray-50 rounded-3xl p-10 text-left mb-12 border border-gray-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Tired of the "Other" Apps?</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     <div className="flex items-start">
                        ...
                        <div>
                           <h4 className="font-bold text-gray-900">Unpredictable Surge Pricing</h4>
                           <p className="text-sm text-gray-600">One minute it's $30, the next it's $90. We keep our prices fair and consistent.</p>
                        </div>
                     </div>
                     <div className="flex items-start">
                        <div className="bg-red-100 p-2 rounded-lg mr-4">
                        ...
                        <div>
                           <h4 className="font-bold text-gray-900">Who is driving you?</h4>
                           <p className="text-sm text-gray-600">We require strict background checks and vehicle inspections. Safety is our #1 priority.</p>
                        </div>
                     </div>
                  </div>
               </div>
