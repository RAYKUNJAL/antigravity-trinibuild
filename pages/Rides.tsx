...
/**
 * Rides stay empty unless live listed drivers are on this island.
      ...
      <div className="max-w-lg mx-auto bg-white rounded-2xl border border-gray-200 p-8">
        ...
        {unavailable ? (
          <div className="text-center pt-2">
            ...
            <p className="mt-4 text-sm"><Link to="/rides/school-run" className="underline">Parent school-run</Link></p>
          </div>
        ) : (
          <>
            ...
            <p className="mt-6 text-sm"><Link to="/rides/school-run" className="underline">Parent school-run</Link></p>
          </>
        )}
      </div>
    </div>
