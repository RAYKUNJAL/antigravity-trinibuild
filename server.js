...
async function handle(req, res) {
  ...
  if (req.method === 'GET' && p === '/') return html(res, 200, marketplace());
  if (req.method === 'GET' && p === '/browse') return html(res, 200, directory());
  if (req.method === 'GET' && p === '/sourcing') return html(res, 200, sourcing());
  if (req.method === 'GET' && p === '/landed-cost') return html(res, 200, landedCost());
  if (req.method === 'GET' && p === '/trade-info') return html(res, 200, tradeInfo());
  if (req.method === 'GET' && p === '/plans') return html(res, 200, plans(auth.auth(req)?.name));
  if (req.method === 'GET' && p === '/login') return html(res, 200, login(auth.auth(req)?.name));
  if (req.method === 'GET' && p === '/signup') return html(res, 200, signup(auth.auth(req)?.name, q.get('role')));
