            ...
            <div className="mb-6">
              ...
              <div className="relative">
                 <input
                    ...
                    placeholder="AIzaSy..."
                    className={`w-full border rounded-md p-3 font-mono text-sm focus:ring-trini-teal focus:border-trini-teal ${
                        geminiStatus === 'success' ? 'border-green-500 bg-green-50' : 
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                  <input
                    ...
                    placeholder="AIzaSy..."
                    className={`w-full border rounded-md p-3 font-mono text-sm focus:ring-trini-teal focus:border-trini-teal ${
                        mapsStatus === 'success' ? 'border-green-500 bg-green-50' : 
              ...
              <p className="text-xs text-gray-500 mt-1">
                  Required for Directory Map. If invalid, app falls back to Gemini AI Grounding.
