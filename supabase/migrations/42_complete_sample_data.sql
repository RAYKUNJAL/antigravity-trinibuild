-- ================================================
-- COMPLETE SAMPLE DATA MIGRATION
-- Migration: 42_complete_sample_data.sql
-- Purpose: Add comprehensive sample data for all marketplace features
-- ================================================

-- ================================================
-- 1. SAMPLE CLASSIFIEDS (Fix empty array issue)
-- ================================================
INSERT INTO classified_listings (title, description, price, category, location, is_featured, image_urls) VALUES
('2018 Toyota Hilux for Sale', 'Excellent condition, low mileage, fully loaded Hilux. Contact for viewing.', 250000, 'Vehicles', 'San Fernando', true, ARRAY['https://images.unsplash.com/photo-1627050019688-a28a1a1f0a2e', 'https://images.unsplash.com/photo-1627050019808-01a75f3a0a6d']),
...
('3 Bedroom House for Rent - Arima', 'Spacious 3 bedroom, 2 bath house in a quiet Arima neighborhood. Parking for 2 cars.', 6500, 'Real Estate', 'Arima', true, ARRAY['https://images.unsplash.com/photo-1512917774080-9991f1c4c750', 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83']),
...
('Luxury 4 Bedroom House - Westmoorings', 'Stunning modern home in prestigious Westmoorings. Features include pool, home theater, and smart home technology.', 4500000, 'House', 4, 3, 3500, 'Westmoorings', 'Westmoorings, Diego Martin', 10.6918, -61.5424, ARRAY['https://images.unsplash.com/photo-1613490493576-7fde63acd811', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9'], ARRAY['Pool', 'Smart Home', 'Home Theater', 'Garage'], true),
('Modern 2 Bedroom Apartment - Trincity', 'Brand new apartment in gated community with gym, pool, and 24/7 security.', 1800000, 'Apartment', 2, 2, 1200, 'Trincity', 'Trincity Mall Area', 10.6525, -61.3925, ARRAY['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2'], ARRAY['Gym', 'Pool', 'Security', 'Parking'], true),
...
-- ================================================
-- 5. SAMPLE PRODUCTS (for storefronts)
-- ================================================
...
-- ================================================
-- 7. SAMPLE VIDEO PLACEMENTS (for home page)
-- ================================================
