-- Apply Store Builder V2 Schema Migration
...
WHERE table_schema = 'public' 
  ...
  AND column_name IN ('tagline', 'logo_style', 'vibe', 'operating_hours', 'delivery_options', 'payment_methods', 'font_pair', 'color_scheme', 'social_links')
